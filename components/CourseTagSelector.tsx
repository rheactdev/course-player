...
export function CourseTagSelector({
  ...
  return (
    <section className={cn(
      'mt-5',
      variant === 'card' && 'border-3 border-foreground bg-card p-3 shadow-[4px_4px_0px_hsl(var(--shadow-color))] sm:p-4',
    )}>
      ...
      <form className="flex max-w-md flex-col gap-2 sm:flex-row" onSubmit={handleSubmit}>
        <Input
          ...
          value={draftTag}
        />
        <Button className="shrink-0" disabled={!normalizeTag(draftTag) || status === 'saving'} size="sm" type="submit">
